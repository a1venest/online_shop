...
const initialState: InitialAppStateType = {
	...
	minPrice: 0,
	sortBy: "дешевле",
	sortByList: ["дешевле", "дороже", "по названию A-Z", "по названию Z-A"],
	sortByBrand: [],
	sortByItemType: [],
	productsList: [],
	productsListCopy: [],
...
export type DefaultSortType = "дешевле" | "дороже" | "по названию A-Z" | "по названию Z-A"
